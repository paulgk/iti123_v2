...
\midrule
Duration $>$ 5 seconds & [WARNING] Warning & Multi-shot video detected. Model samples across entire video causing mixed signals. Trim to 2-3s. \\
Duration $<$ 1.5 seconds & [INFO] Info & Video too short to capture full motion. Record 2-3s including prep and follow-through. \\
Confidence $<$ 60\% & [WARNING] Warning & Low confidence. Check camera angle (use side-court view), lighting, and video quality. \\
Confidence $<$ 70\% AND Duration $>$ 3s & [WARNING] Warning & Low confidence with long video. Likely contains multiple shots. Trim to single shot. \\
Confidence $>$ 85\% & [OK] Success & High confidence! Video angle and execution match training data well. \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{verbatim}
[WARNING] Video is longer than 5 seconds
...
\midrule
\textbf{Side-court (training)} & [OK] 74.6\% & Exact match to training distribution \\
Slight elevation change ($\pm$20°) & [OK] 70--75\% & ResNet features partially rotation-invariant \\
Front/back court view & [WARNING] 50--65\% & Different perspective, altered motion patterns \\
Player POV (GoPro) & [FAIL] 30--50\% & Close-up, missing court context \\
Overhead (bird's eye) & [FAIL] 30--50\% & Completely different view, no depth \\
Close-up (upper body only) & [FAIL] 40--55\% & Missing footwork and court positioning \\
\bottomrule
\end{tabular}
\end{table}
...
\quad Shot type classification (5 classes) & [OK] & 74.6\% accuracy \\
\quad Confidence scores & [OK] & 0--100\% display \\
\quad All class probabilities & [OK] & Sorted bar charts \\
\quad Video upload (web interface) & [OK] & MP4/AVI/MOV support \\
\midrule
\textbf{Transparency Features} & & \\
\quad Video metadata display & [OK] & Duration, FPS, frames \\
\quad Frame sampling timeline & [OK] & Shows which frames analyzed \\
\quad Smart warnings & [OK] & Context-aware guidance \\
\quad Model info disclosure & [OK] & Architecture, accuracy shown \\
\midrule
\textbf{User Experience} & & \\
\quad Processing speed & [OK] & 5--10 seconds per video \\
\quad Error handling & [OK] & Graceful failure messages \\
\quad Shot descriptions & [OK] & Tactical explanations \\
\quad Alternative predictions & [OK] & Top-3 alternatives shown \\
\midrule
\textbf{Privacy \& Security} & & \\
\quad On-device processing & [OK] & No cloud upload \\
\quad Immediate file deletion & [OK] & No data retention \\
\quad No user tracking & [OK] & No analytics \\
\midrule
\textbf{Future Enhancements} & & \\
\quad Automatic shot segmentation & [FAIL] & Planned (multi-shot videos) \\
\quad Visual overlays & [FAIL] & Planned (skeleton on video) \\
\quad Technique analysis & [FAIL] & Disabled (pose issues) \\
\quad Mobile app & [FAIL] & Future work \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\textbf{Outcome} & & \\
\quad Success & [FAIL] Failed & [OK] Succeeded \\
...
\midrule
\textbf{Transparency} & [OK] Implemented & Confidence, probabilities, metadata shown \\
\textbf{Explainability} & [WARNING] Partial & Predictions explained, but no saliency maps \\
\textbf{Privacy} & [OK] Implemented & On-device, no retention, no tracking \\
\textbf{Security} & [WARNING] Basic & Input validation, error handling (audit needed) \\
\textbf{Safety} & [OK] Implemented & Graceful failures, confidence warnings \\
\textbf{Fairness} & [WARNING] Partial & Biases identified, testing needed \\
\textbf{Accountability} & [WARNING] Partial & Documentation exists, feedback mechanism needed \\
\textbf{Human Oversight} & [OK] Implemented & User controls upload, sees confidence, makes decisions \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
\item [OK] \textbf{Current state:} Safe for beta testing with informed users
\item [WARNING] \textbf{Before wide release:} Fairness testing, security audit, formal model card
\item [FAIL] \textbf{Not ready for:} High-stakes decisions (e.g., competitive ranking, coaching certification)
\end{itemize}
...
# [OK] Shot Type: Smash (94.3% confidence)
#
# Video Analysis Info:
#   Duration: 2.47s
#   Total frames: 74
...
Video Requirements:
- [WARNING] ONE shot per video (model samples frames across entire video)
...
[OK] High confidence - video angle matches training data well!
...
[INFO] * Smash - Powerful attacking shot hit downward. The primary
...
-------------------------------------------------------------------
[INFO] Note: Technique analysis (biomechanics, form scoring) is
